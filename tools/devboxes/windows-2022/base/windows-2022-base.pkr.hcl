...
# mandatory.
#
# To set this variable, run the `fetch-virtio-win-iso.sh` script next to this Packer template. The
# script will download the VirtIO ISO file into this directory, and create a ...auto.pkrvars.hcl
# file next to it which sets this variable.
...
build {
  ...
  #   scripts = [
  # "${path.root}/scripts/debloat-windows.ps1",
  #   ]
  # }

  # TODO: windows-restart?
