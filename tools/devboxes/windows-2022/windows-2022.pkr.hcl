...
build {
  ...
  provisioner "powershell" {
    ...
    scripts = [
      ...
      # Bazel custom root CA config
    ]
  }

  # provisioner "windows-shell" {
  #   # https://learn.microsoft.com/en-us/visualstudio/install/workload-component-id-vs-build-tools?view=vs-2022&preserve-view=true#desktop-development-with-c
  #   inline = ["winget install -e --id Microsoft.VisualStudio.2022.BuildTools --override \"--passive --wait --add Microsoft.VisualStudio.Workload.VCTools;includeRecommended;includeOptional\""]
  # }
}
